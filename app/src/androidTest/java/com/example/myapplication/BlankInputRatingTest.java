...
public class BlankInputRatingTest {
    ...
    public void testInvalidRatingSubmission() {
        ...
        onView(withId(R.id.workloadRating)).perform(typeText(""), closeSoftKeyboard());
        onView(withId(R.id.courseScore)).perform(typeText(""), closeSoftKeyboard());
        onView(withId(R.id.checksAttendance)).perform(click());
        onView(withId(R.id.allowsLateSubmission)).perform(click());
        onView(withId(R.id.comments)).perform(typeText("testing blank answers"), closeSoftKeyboard());
